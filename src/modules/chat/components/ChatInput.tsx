...
export const ChatInput = ({ sendMessage }: { sendMessage: (message: string) => void }) => {
  ...
  return (
    <HStack className="justify-between rounded-xl bg-card p-4 hover:brightness-125">
      <input
        placeholder={t`Ask another question`}
        className="grow bg-transparent text-sm leading-4 text-white ring-offset-background placeholder:text-violet-200/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:placeholder:text-violet-200/20"
        value={inputText}
