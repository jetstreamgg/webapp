...
export const ChatPane = ({ sendMessage }: { sendMessage: (message: string) => void }) => {
  ...
  return (
    ...
    <motion.div
      className="chat-pane flex h-full w-full flex-col group-has-[.details-pane]:w-[324px] md:rounded-3xl md:bg-panel"
      layout
      key="chat-pane"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    >
      ...
      <div className="h-[calc(100%-65px)] px-6 pb-4 pt-[22px] @container/chat md:h-full xl:pb-5 xl:pt-8">
