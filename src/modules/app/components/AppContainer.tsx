...
export function AppContainer({ children }: { children: React.ReactNode }): React.ReactElement {
  ...
  return (
    <motion.main
      className="scrollbar-hidden md:scrollbar-thin group flex h-screen min-w-[375px] max-w-[480px] flex-col gap-3 overflow-y-auto overflow-x-hidden rounded-t-3xl border bg-container bg-blend-overlay backdrop-blur-[50px] has-[.chat-pane]:w-full has-[.details-pane]:w-full md:my-auto md:max-h-[1080px] md:max-w-[1150px] md:flex-row md:overflow-hidden md:rounded-3xl md:p-3 md:pr-0.5 xl:max-w-[calc(100vw-128px)] 2xl:max-w-[1270px] 3xl:max-w-[1392px]"
      layout
