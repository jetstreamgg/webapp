...
export const DetailsPane = ({ intent }: DetailsPaneProps) => {
  ...
  return (
    ...
    <motion.div
      className="scrollbar-thin details-pane flex w-full flex-col gap-4 bg-panel p-3 group-has-[.chat-pane]:w-[calc(100%-764px)] md:overflow-auto md:rounded-3xl md:p-6 md:pr-3.5 xl:p-8 xl:pr-[22px]"
      layout
      key="details-pane"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
